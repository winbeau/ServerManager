...
public:
    ...
    void setupUi(QMainWindow *mainwindow)
    {
        ...
        actiondsA->setObjectName("actiondsA");
        ...
        distriButton->setObjectName("distriButton");
        ...
        imitateButton->setObjectName("imitateButton");
        ...
        storBox->setObjectName("storBox");
        storProBar = new QProgressBar(storBox);
        storProBar->setObjectName("storProBar");
        ...
        storLabel->setObjectName("storLabel");
        ...
        storFrame->setObjectName("storFrame");
        ...
        vituLabel->setObjectName("vituLabel");

        storLayout->addWidget(vituLabel);

        diskIcon = new QLabel(storBox);
        diskIcon->setObjectName("diskIcon");
        ...
        machBox->setObjectName("machBox");
        memoProBar = new QProgressBar(machBox);
        memoProBar->setObjectName("memoProBar");
        ...
        duriLayout->setObjectName("duriLayout");
        ...
        procBox->setObjectName("procBox");
        cpuProBar = new QProgressBar(procBox);
        cpuProBar->setObjectName("cpuProBar");
        ...
        procFrame->setObjectName("procFrame");
